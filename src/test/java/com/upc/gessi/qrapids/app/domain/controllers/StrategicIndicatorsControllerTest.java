...
public class StrategicIndicatorsControllerTest {
    ...
    public void getStrategicIndicatorsByProjectAndProfile() throws ProjectNotFoundException {
        ...
        when(strategicIndicatorRepository.findByProject_IdOrderByName(project.getId()))
                .thenReturn(strategicIndicatorList);

        // When
        List<Strategic_Indicator> strategicIndicatorListFound = strategicIndicatorsController
                .getStrategicIndicatorsByProjectAndProfile(project.getExternalId(), null); // without profile
    ...
    public void getStrategicIndicatorById() throws StrategicIndicatorNotFoundException {
        ...
        Project project = domainObjectsBuilder.buildProject();
        Strategic_Indicator strategicIndicator = domainObjectsBuilder.buildStrategicIndicator(project);
        when(strategicIndicatorRepository.findById(strategicIndicator.getId()))
                .thenReturn(Optional.of(strategicIndicator));

        // When
        Strategic_Indicator strategicIndicatorFound = strategicIndicatorsController
    ...
    public void saveStrategicIndicator() throws IOException, QualityFactorNotFoundException {
        ...
        List<StrategicIndicatorQualityFactors> qualityFactors = domainObjectsBuilder
                .buildQualityFactors(strategicIndicator);
        for (StrategicIndicatorQualityFactors qf : qualityFactors) {
            ...
            when(strategicIndicatorQualityFactorsController.saveStrategicIndicatorQualityFactor(eq(qf.getFactor()),
                    eq(qf.getWeight()), any(Strategic_Indicator.class))).thenReturn(qf);
        }

        // When
        strategicIndicatorsController.saveStrategicIndicator(strategicIndicator.getName(),
                strategicIndicator.getDescription(), strategicIndicator.getThreshold().toString(),
                Files.readAllBytes(networkFile.toPath()), strategicIndicator.getWeights(), project);
    ...
    public void editStrategicIndicator() throws IOException, StrategicIndicatorNotFoundException,
            StrategicIndicatorQualityFactorNotFoundException, QualityFactorNotFoundException {
        // Given
        Project project = domainObjectsBuilder.buildProject();
        Strategic_Indicator strategicIndicator = domainObjectsBuilder.buildStrategicIndicator(project);
        File networkFile = new File("src/test/java/com/upc/gessi/qrapids/app/testHelpers/WSA_ProductQuality.dne");
        ...
        List<StrategicIndicatorQualityFactors> qualityFactors = domainObjectsBuilder
                .buildQualityFactors(strategicIndicator);
        when(strategicIndicatorQualityFactorsRepository.findByStrategic_indicator(strategicIndicator))
                .thenReturn(qualityFactors);
        for (StrategicIndicatorQualityFactors qf : qualityFactors) {
            when(factorsController.getQualityFactorById(eq(qf.getFactor().getId()))).thenReturn(qf.getFactor());
            when(strategicIndicatorQualityFactorsController.saveStrategicIndicatorQualityFactor(eq(qf.getFactor()),
                    eq(qf.getWeight()), any(Strategic_Indicator.class))).thenReturn(qf);
        ...
        // When
        strategicIndicatorsController.editStrategicIndicator(strategicIndicator.getId(), strategicIndicator.getName(),
                strategicIndicator.getDescription(), strategicIndicator.getThreshold().toString(),
                Files.readAllBytes(networkFile.toPath()), strategicIndicator.getWeights());
    ...
    public void deleteStrategicIndicator() throws StrategicIndicatorNotFoundException {
        ...
        when(profileProjectStrategicIndicatorsRepository.findByStrategic_indicator(strategicIndicator))
                .thenReturn(null);
    ...
    @Test
    public void getAllStrategicIndicatorsCurrentEvaluation()
        ...
        when(qmaStrategicIndicators.CurrentEvaluation(projectExternalId, profileId))
                .thenReturn(dtoStrategicIndicatorEvaluationList);

        // When
        List<DTOStrategicIndicatorEvaluation> dtoStrategicIndicatorEvaluationListFound = strategicIndicatorsController
    ...
    @Test
    public void getSingleStrategicIndicatorsCurrentEvaluation()
            throws IOException, CategoriesException, ProjectNotFoundException {
        // Given
        String projectExternalId = "test";
        String profileId = "null"; // without profile
        DTOStrategicIndicatorEvaluation dtoStrategicIndicatorEvaluation = domainObjectsBuilder
                .buildDTOStrategicIndicatorEvaluation();
        when(qmaStrategicIndicators.SingleCurrentEvaluation(projectExternalId, profileId,
                dtoStrategicIndicatorEvaluation.getId())).thenReturn(dtoStrategicIndicatorEvaluation);

        // When
        DTOStrategicIndicatorEvaluation dtoStrategicIndicatorEvaluationFound = strategicIndicatorsController
                .getSingleStrategicIndicatorsCurrentEvaluation(dtoStrategicIndicatorEvaluation.getId(),
                        projectExternalId, profileId);
    ...
    public void getAllDetailedStrategicIndicatorsCurrentEvaluation() throws IOException, ProjectNotFoundException {
        ...
        DTODetailedStrategicIndicatorEvaluation dtoDetailedStrategicIndicator = new DTODetailedStrategicIndicatorEvaluation(
                dtoStrategicIndicatorEvaluation.getId(), dtoStrategicIndicatorEvaluation.getName(),
                dtoFactorEvaluationList);
        ...
        when(qmaDetailedStrategicIndicators.CurrentEvaluation(null, projectExternalId, profileId, true))
                .thenReturn(dtoDetailedStrategicIndicatorList);

        // When
        List<DTODetailedStrategicIndicatorEvaluation> dtoDetailedStrategicIndicatorListFound = strategicIndicatorsController
    ...
    public void getSingleDetailedStrategicIndicatorCurrentEvaluation() throws IOException, ProjectNotFoundException {
        ...
        when(qmaDetailedStrategicIndicators.CurrentEvaluation(dtoStrategicIndicatorEvaluation.getId(),
                projectExternalId, profileId, true)).thenReturn(dtoDetailedStrategicIndicatorList);

        // When
        List<DTODetailedStrategicIndicatorEvaluation> dtoDetailedStrategicIndicatorListFound = strategicIndicatorsController
                .getSingleDetailedStrategicIndicatorCurrentEvaluation(dtoDetailedStrategicIndicator.getId(),
                        projectExternalId, profileId);
    ...
    @Test
    public void getAllStrategicIndicatorsHistoricalEvaluation()
            throws IOException, CategoriesException, ProjectNotFoundException {
        // Given
        String projectExternalId = "test";
        String profileId = "null"; // without profile
        ...
        when(qmaStrategicIndicators.HistoricalData(fromDate, toDate, projectExternalId, profileId))
                .thenReturn(dtoStrategicIndicatorEvaluationList);

        // When
        List<DTOStrategicIndicatorEvaluation> dtoStrategicIndicatorEvaluationListFound = strategicIndicatorsController
                .getAllStrategicIndicatorsHistoricalEvaluation(projectExternalId, profileId, fromDate, toDate);
    ...
    public void getAllDetailedStrategicIndicatorsHistoricalEvaluation() throws IOException, ProjectNotFoundException {
        ...
        String to = "2019-07-15";
        LocalDate toDate = LocalDate.parse(to);
        when(qmaDetailedStrategicIndicators.HistoricalData(null, fromDate, toDate, projectExternalId, profileId))
                .thenReturn(dtoDetailedStrategicIndicatorList);

        // When
        List<DTODetailedStrategicIndicatorEvaluation> dtoDetailedStrategicIndicatorListFound = strategicIndicatorsController
                .getAllDetailedStrategicIndicatorsHistoricalEvaluation(projectExternalId, profileId, fromDate, toDate);
    ...
    @Test
    public void getSingleDetailedStrategicIndicatorsHistoricalEvaluation()
        ...
        String to = "2019-07-15";
        LocalDate toDate = LocalDate.parse(to);
        when(qmaDetailedStrategicIndicators.HistoricalData(dtoDetailedStrategicIndicator.getId(), fromDate, toDate,
                projectExternalId, profileId)).thenReturn(dtoDetailedStrategicIndicatorList);

        // When
        List<DTODetailedStrategicIndicatorEvaluation> dtoDetailedStrategicIndicatorListFound = strategicIndicatorsController
                .getSingleDetailedStrategicIndicatorsHistoricalEvaluation(dtoDetailedStrategicIndicator.getId(),
    ...
    public void getStrategicIndicatorsPrediction() throws IOException {
        ...
        when(qmaForecast.ForecastSI(dtoStrategicIndicatorEvaluationList, technique, freq, horizon, projectExternalId))
                .thenReturn(dtoStrategicIndicatorEvaluationList);

        // When
        List<DTOStrategicIndicatorEvaluation> dtoStrategicIndicatorEvaluationListFound = strategicIndicatorsController
                .getStrategicIndicatorsPrediction(dtoStrategicIndicatorEvaluationList, technique, freq, horizon,
                        projectExternalId);
    ...
    public void getDetailedStrategicIndicatorsPrediction() throws IOException {
        ...
        when(qmaForecast.ForecastDSI(anyList(), eq(technique), eq(freq), eq(horizon), eq(projectExternalId)))
                .thenReturn(dtoDetailedStrategicIndicatorList);

        // When
        List<DTODetailedStrategicIndicatorEvaluation> dtoDetailedStrategicIndicatorListFound = strategicIndicatorsController
                .getDetailedStrategicIndicatorsPrediction(dtoDetailedStrategicIndicatorList, technique, freq, horizon,
                        projectExternalId);
    ...
    public void trainForecastModelsAllProjects() throws IOException, CategoriesException, ProjectNotFoundException {
        ...
        when(metricsController.getAllMetricsCurrentEvaluation(projectExternalId, profileId))
        ...
        when(factorsController.getAllFactorsWithMetricsCurrentEvaluation(projectExternalId, profileId, false))
        ...
        verify(qmaForecast, times(1)).trainFactorForecast(dtoDetailedFactorEvaluationList, "7", projectExternalId,
                technique);
    }
    ...
    public void trainForecastModelsSingleProject() throws IOException, CategoriesException, ProjectNotFoundException {
        ...
        DTOStrategicIndicatorEvaluation dtoStrategicIndicator = domainObjectsBuilder
                .buildDTOStrategicIndicatorEvaluation();
        ...
        when(strategicIndicatorsController.getAllStrategicIndicatorsCurrentEvaluation(projectExternalId, profileId))
                .thenReturn(dtoStrategicIndicatorList);
        ...
        verify(qmaForecast, times(1)).trainFactorForecast(dtoDetailedFactorEvaluationList, "7", projectExternalId,
                technique);
        verify(qmaForecast, times(1)).trainStrategicIndicatorForecast(dtoStrategicIndicatorList, "7", projectExternalId,
                technique);
    }

    @Test
    public void assessStrategicIndicators()
            throws IOException, CategoriesException, ArithmeticException, ProjectNotFoundException {
        Project project = domainObjectsBuilder.buildProject();
        when(projectsController.findProjectByExternalId(project.getExternalId())).thenReturn(project);
        ...
        when(factorsController.getAllFactorsEvaluation(project.getExternalId(), null, false))
        ...
        Metric metric3 = new Metric("fasttests", "Fast Tests",
                ...
                "Fast Tests category", null);
        Factor factor3 = new Factor("testingperformance", "Performance of testing phases",
        ...
        when(qmaStrategicIndicators.setStrategicIndicatorValue(eq(project.getExternalId()),
                eq(strategicIndicator.getExternalId()), eq(strategicIndicatorName), eq(strategicIndicatorDescription),
                eq(factorsAverageValue.floatValue()), anyString(), ArgumentMatchers.any(LocalDate.class), isNull(),
                anyList(), eq(0L))).thenReturn(true);
        ...
        when(qmaRelations.setStrategicIndicatorFactorRelation(eq(project.getExternalId()),
                eq(strategicIndicator.getQuality_factors()), eq(strategicIndicator.getExternalId()),
                ArgumentMatchers.any(LocalDate.class), eq(factorWeightsList), eq(factorWeightedValuesList),
                eq(factorCategoryNamesList), eq(factorsAverageValue.toString()))).thenReturn(true);
        ...
        verify(factorsController, times(1)).setFactorStrategicIndicatorRelation(dtoFactorEvaluationList,
        ...
        verify(qmaStrategicIndicators, times(1)).setStrategicIndicatorValue(eq(project.getExternalId()),
                eq(strategicIndicator.getExternalId()), eq(strategicIndicatorName), eq(strategicIndicatorDescription),
                eq(factorsAverageValue.floatValue()), anyString(), ArgumentMatchers.any(LocalDate.class), isNull(),
                anyList(), eq(0L));
        ...
        verify(qmaRelations, times(1)).setStrategicIndicatorFactorRelation(eq(project.getExternalId()),
                eq(strategicIndicator.getQuality_factors()), eq(strategicIndicator.getExternalId()),
                ArgumentMatchers.any(LocalDate.class), eq(factorWeightsList), eq(factorWeightedValuesList),
                eq(factorCategoryNamesList), eq(factorsAverageValue.toString()));
        verifyNoMoreInteractions(qmaRelations);
    }

    @Test
    public void assessStrategicIndicatorsNotCorrect()
            throws IOException, CategoriesException, ProjectNotFoundException {
        Project project = domainObjectsBuilder.buildProject();
        when(projectsController.findProjectByExternalId(project.getExternalId())).thenReturn(project);
        ...
        // when(qmaStrategicIndicators.setStrategicIndicatorValue(eq(project.getExternalId()),
        // eq(strategicIndicator.getExternalId()), eq(strategicIndicatorName),
        // eq(strategicIndicatorDescription), eq(factorsAverageValue.floatValue()),
        // eq(strategicIndicatorRationale), ArgumentMatchers.any(LocalDate.class),
        // isNull(), anyList(), eq(0L))).thenReturn(false);
    ...
    public void assessStrategicIndicator() throws IOException, ProjectNotFoundException {
        ...
        when(strategicIndicatorRepository.findByNameAndProject_Id(strategicIndicatorName, project.getId()))
        ...
        verify(strategicIndicatorRepository, times(1)).findByNameAndProject_Id(strategicIndicator.getName(),
                project.getId());
        verifyNoMoreInteractions(strategicIndicatorRepository);
    ...
    public void getValueAndLabelFromCategories() {
        ...
        // When
        Pair<Float, String> valueLabelPair = strategicIndicatorsController
                .getValueAndLabelFromCategories(dtoSIAssessmentList);
    ...
    public void fetchStrategicIndicators()
            throws IOException, CategoriesException, ProjectNotFoundException, QualityFactorNotFoundException,
            StrategicIndicatorQualityFactorNotFoundException, StrategicIndicatorNotFoundException {
        Project project = domainObjectsBuilder.buildProject();
        List<String> projectsList = new ArrayList<>();
        ...
        when(qmaDetailedStrategicIndicators.CurrentEvaluation(null, project.getExternalId(), null, false))
                .thenReturn(dtoDetailedStrategicIndicatorList);
        for (DTOFactorEvaluation qf : dtoFactorEvaluationList) {
            Factor f = new Factor(qf.getId(), qf.getDescription(), project, qf.getType(), qf.getDatasource());
            f.setId(1L);
            when(factorsController.findFactorByExternalIdAndProjectId(any(String.class), eq(project.getId())))
                    .thenReturn(f);
        }
    ...
    public void simulateStrategicIndicatorsAssessment() throws IOException, ProjectNotFoundException {
        ...
        List<DTOFactorEvaluation> dtoFactorEvaluationList = new ArrayList<>();
        dtoFactorEvaluationList.add(dtoFactorEvaluation);
        when(factorsController.getAllFactorsEvaluation(project.getExternalId(), null, true))
                .thenReturn(dtoFactorEvaluationList);
        ...
        strategic_indicatorList.add(strategicIndicator);
        when(strategicIndicatorRepository.findByProject_IdOrderByName(project.getId()))
                .thenReturn(strategic_indicatorList);

        List<SICategory> siCategoryList = domainObjectsBuilder.buildSICategoryList();
        when(siCategoryRepository.findAll()).thenReturn(siCategoryList);

        // When
        List<DTOStrategicIndicatorEvaluation> dtoStrategicIndicatorEvaluationList = strategicIndicatorsController
                .simulateStrategicIndicatorsAssessment(factorSimulatedMap, project.getExternalId(), null); // without
                                                                                                           // profile
        ...
        DTOStrategicIndicatorEvaluation dtoStrategicIndicatorEvaluationFound = dtoStrategicIndicatorEvaluationList
                .get(0);
    ...
    public void computeStrategicIndicatorValue() {
        ...
        // Then
        float expectedValue = (dtoFactorEvaluation1.getValue().getFirst() + dtoFactorEvaluation2.getValue().getFirst()
                + dtoFactorEvaluation3.getValue().getFirst()) / dtoFactorEvaluationList.size();
