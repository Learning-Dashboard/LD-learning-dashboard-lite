...
public class ProductRepositoryTest {
    ...
    public void findByName() {
        // Given
        Project project1 = new Project("project1", "Project 1", "test project", null, true, false, null);
        entityManager.persist(project1);
        Project project2 = new Project("project2", "Project 2", "test project", null, true, false, null);
        ...
        Project project3 = new Project("project3", "Project 3", "test project", null, true, false, null);
        entityManager.persist(project3);
        Project project4 = new Project("project4", "Project 4", "test project", null, true, false, null);
