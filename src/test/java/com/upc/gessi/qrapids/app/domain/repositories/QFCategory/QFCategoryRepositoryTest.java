...
public class QFCategoryRepositoryTest {
    ...
    public void findAllByOrderByUpperThresholdAsc() {
        // Given
        QFCategory qfCategoryBad = new QFCategory("Default", "Default", "#ff0000", 0.33f, "Bad");
        entityManager.persist(qfCategoryBad);

        QFCategory qfCategoryGood = new QFCategory("Default", "Default", "#00ff00", 1f, "Good");
        entityManager.persist(qfCategoryGood);

        QFCategory qfCategoryNeutral = new QFCategory("Default", "Default", "#ff8000", 0.67f, "Neutral");
    ...
    public void findAllByCategoryName() {
        // Given
        QFCategory qfCategoryDefaultBad = new QFCategory("Default", "Default", "#ff0000", 0.33f, "Bad");
        entityManager.persist(qfCategoryDefaultBad);

        QFCategory qfCategoryDefaultGood = new QFCategory("Default", "Default", "#00ff00", 1f, "Good");
        entityManager.persist(qfCategoryDefaultGood);

        QFCategory qfCategoryDefaultNeutral = new QFCategory("Default", "Default", "#ff8000", 0.67f, "Neutral");
        entityManager.persist(qfCategoryDefaultNeutral);

        QFCategory qfCategory6memUp = new QFCategory("6 members contribution", "Default", "#ff0000", 1f, "Up");
        entityManager.persist(qfCategory6memUp);

        QFCategory qfCategory6memHigh = new QFCategory("6 members contribution", "Default", "#00ff00", 0.8f, "High");
        entityManager.persist(qfCategory6memHigh);

        QFCategory qfCategory6memGood = new QFCategory("6 members contribution", "Default", "#00ff00", 0.5f, "Neutral");
        entityManager.persist(qfCategory6memGood);

        QFCategory qfCategory6memLow = new QFCategory("6 members contribution", "Default", "#ff8000", 0.3f, "Low");
        entityManager.persistAndFlush(qfCategory6memLow);

        QFCategory qfCategory6memDown = new QFCategory("6 members contribution", "Default", "#ff8000", 0.15f, "Down");
