...
public class StrategicIndicatorFactorEvaluationRepositoryTest {
    ...
    public void findByStrategic_indicatorId() {
        ...
        // When
        List<StrategicIndicatorQualityFactors> strategicIndicatorQualityFactorsList = strategicIndicatorQualityFactorsRepository
                .findByStrategic_indicator(strategicIndicator1);
