...
public class FactorEvaluationTest {
        ...
        public void getFactorsCategories() throws Exception {
                ...
                this.mockMvc.perform(requestBuilder)
                                ...
                                // .andExpect(jsonPath("$", hasSize(3))) Because now there is more than 3
                                // categoreis
                                ...
                                .andExpect(jsonPath("$[0].upperThreshold",
                                                is(HelperFunctions.getFloatAsDouble(
                                                                factorCategoryList.get(0).getUpperThreshold()))))
                                ...
                                .andExpect(jsonPath("$[1].upperThreshold",
                                                is(HelperFunctions.getFloatAsDouble(
                                                                factorCategoryList.get(1).getUpperThreshold()))))
                                ...
                                .andExpect(jsonPath("$[2].upperThreshold",
                                                is(HelperFunctions.getFloatAsDouble(
                                                                factorCategoryList.get(2).getUpperThreshold()))))
                                .andDo(document("qf/categories",
                                                ...
                                                responseFields(
                                                                ...
                                                                fieldWithPath("[].patternGroup")
                                                                                .description("Pattern group name"),
                                                                fieldWithPath("[].type")
                                ...
                                .andDo(document("qf/categories-new",
                                                ...
                                                requestParameters(
                                                                parameterWithName("name")
                                                                                .description("Category name (Optional)")
                                                                                .optional(),
                                                                parameterWithName("patternGroup")
                                                                                .description("Pattern group name (Optional)")
                                                                                .optional()),
                                                requestFields(
                                                                fieldWithPath("[].type")
                                                                                .description("Quality factors category type"),
        ...
        public void newFactorsCategoriesNotEnough() throws Exception {
                ...
                // Verify mock interactions
                verify(qualityFactorsDomainController, times(1)).newFactorCategories(factorCategoriesList, "Default", "Default");
                verifyNoMoreInteractions(qualityFactorsDomainController);
        }
        ...
        public void getQualityFactorsEvaluations() throws Exception {
                ...
                when(qualityFactorsDomainController.getAllFactorsWithMetricsCurrentEvaluation(projectExternalId, null,
                                true)).thenReturn(dtoDetailedFactorEvaluationList);
                ...
                verify(qualityFactorsDomainController, times(1))
                                .getAllFactorsWithMetricsCurrentEvaluation(projectExternalId, null, true);
                verifyNoMoreInteractions(qualityFactorsDomainController);
        }
        ...
        public void getSingleFactorEvaluation() throws Exception {
                ...
                String projectExternalId = "test";
                when(qualityFactorsDomainController.getSingleFactorEvaluation(dtoFactorEvaluation.getId(),
                                projectExternalId)).thenReturn(dtoFactorEvaluation);
                ...
                this.mockMvc.perform(requestBuilder)
                                ...
                                .andExpect(jsonPath("$.value.first",
                                                is(HelperFunctions.getFloatAsDouble(
                                                                dtoFactorEvaluation.getValue().getFirst()))))
                                ...
                                .andExpect(jsonPath("$.strategicIndicators[0]",
                ...
                // Verify mock interactions
                verify(qualityFactorsDomainController, times(1)).getSingleFactorEvaluation(dtoFactorEvaluation.getId(),
                                projectExternalId);
                verifyNoMoreInteractions(qualityFactorsDomainController);
        }
        ...
        public void getDetailedQualityFactorsHistoricalData() throws Exception {
                ...
                when(qualityFactorsDomainController.getAllFactorsWithMetricsHistoricalEvaluation(projectExternalId,
                                null, from, to)).thenReturn(dtoDetailedFactorEvaluationList);
                ...
                // Verify mock interactions
                verify(qualityFactorsDomainController, times(1))
                                .getAllFactorsWithMetricsHistoricalEvaluation(projectExternalId, null, from, to);
                verifyNoMoreInteractions(qualityFactorsDomainController);
        }
        ...
        public void getAllDetailedQualityFactors() throws Exception {
                ...
                String projectExternalId = "test";
                when(qualityFactorsDomainController.getAllFactorsEvaluation(projectExternalId, null, true))
                ...
                this.mockMvc.perform(requestBuilder)
                                ...
                                .andExpect(jsonPath("$[0].mismatchDays", is(0)))
                                .andExpect(jsonPath("$[0].missingMetrics", is(nullValue())))
                                .andExpect(jsonPath("$[0].strategicIndicators[0]",
                                                is(dtoFactorEvaluation.getStrategicIndicators().get(0))))
        ...
        public void simulate() throws Exception {
                ...
                when(qualityFactorsDomainController.simulate(metricsMap, projectExternalId, null,
                                LocalDate.parse(date))).thenReturn(dtoFactorEvaluationList);
                ...
                // Verify mock interactions
                verify(qualityFactorsDomainController, times(1)).simulate(metricsMap, projectExternalId, null,
        ...
        public void getMetricsEvaluationForQF() throws Exception {
                ...
                when(metricsDomainController.getMetricsForQualityFactorCurrentEvaluation(factorId, projectExternalId))
                                .thenReturn(dtoMetricEvaluationList);
                when(qualityFactorsDomainController.getSingleFactorEvaluation(factorId, projectExternalId))
                                .thenReturn(f);
                ...
                this.mockMvc.perform(requestBuilder)
                                ...
                                .andExpect(jsonPath("$[0].value.first",
                                                is(HelperFunctions.getFloatAsDouble(f.getValue().getFirst()))))
                                ...
                                .andExpect(jsonPath("$[0].metrics[0].description",
                                                is(dtoMetricEvaluation.getDescription())))
                                .andExpect(jsonPath("$[0].metrics[0].value",
                                                is(HelperFunctions.getFloatAsDouble(dtoMetricEvaluation.getValue()))))
                                .andExpect(jsonPath("$[0].metrics[0].value_description",
                                                is(String.format("%.2f", dtoMetricEvaluation.getValue()))))
                                .andExpect(jsonPath("$[0].metrics[0].date[0]",
                                                is(dtoMetricEvaluation.getDate().getYear())))
                                .andExpect(jsonPath("$[0].metrics[0].date[1]",
                                                is(dtoMetricEvaluation.getDate().getMonthValue())))
                                .andExpect(jsonPath("$[0].metrics[0].date[2]",
                                                is(dtoMetricEvaluation.getDate().getDayOfMonth())))
                                .andExpect(jsonPath("$[0].metrics[0].datasource", is(nullValue())))
                                .andExpect(jsonPath("$[0].metrics[0].rationale",
                                                is(dtoMetricEvaluation.getRationale())))
                                .andExpect(jsonPath("$[0].metrics[0].confidence80", is(nullValue())))
                                .andExpect(jsonPath("$[0].metrics[0].confidence95", is(nullValue())))
                                .andExpect(jsonPath("$[0].metrics[0].forecastingError", is(nullValue())))
                                .andExpect(jsonPath("$[0].metrics[0].qualityFactors",
                                                is(dtoMetricEvaluation.getQualityFactors())))
                                .andExpect(jsonPath("$[0].type", is(nullValue())))
                                .andDo(document("metrics/current-qf",
                                                ...
                                                responseFields(
                                                                ...
                                                                fieldWithPath("[].type")
                                                                                .description("Datasource from where the data is taken"),
                                                                fieldWithPath("[].strategicIndicators").type(JsonFieldType.ARRAY).optional()
                                                                                .description("List of the strategic indicators that use this quality factor"),
                                                                fieldWithPath("[].formattedDate").type(JsonFieldType.STRING).optional()
                                                                                .description("Readable quality factor evaluation date"),
                                                                fieldWithPath("[].datasource").type(JsonFieldType.STRING).optional()
                                                                                .description("Quality factor source of data"),
                                                                fieldWithPath("[].rationale").type(JsonFieldType.STRING).optional()
                                                                                .description("Quality factor evaluation rationale"),
                                                                fieldWithPath("[].confidence80").type(JsonFieldType.VARIES).optional()
                                                                                .description("Quality factor forecasting 80% confidence interval"),
                                                                fieldWithPath("[].confidence95").type(JsonFieldType.VARIES).optional()
                                                                                .description("Quality factor forecasting 95% confidence interval"),
                                                                fieldWithPath("[].forecastingError").type(JsonFieldType.STRING).optional()
                                                                                .description("Description of forecasting errors"))));

                // Verify mock interactions
                verify(metricsDomainController, times(1)).getMetricsForQualityFactorCurrentEvaluation(factorId,
                                projectExternalId);
        ...
        public void getMetricsHistoricalDataForQF() throws Exception {
                ...
                when(metricsDomainController.getMetricsForQualityFactorHistoricalEvaluation(factorId, projectExternalId,
                                LocalDate.parse(dateFrom), LocalDate.parse(dateTo)))
                                .thenReturn(dtoMetricEvaluationList);
                when(qualityFactorsDomainController.getSingleFactorEvaluation(factorId, projectExternalId))
                                .thenReturn(factorEvaluation);
                ...
                // Verify mock interactions
                verify(metricsDomainController, times(1)).getMetricsForQualityFactorHistoricalEvaluation(factorId,
                                projectExternalId, LocalDate.parse(dateFrom), LocalDate.parse(dateTo));
                verifyNoMoreInteractions(metricsDomainController);
        ...
        public void getMetricsPredictionDataForQF() throws Exception {
                ...
                when(metricsDomainController.getMetricsPrediction(dtoMetricEvaluationList, projectExternalId, technique,
                                freq, horizon)).thenReturn(dtoMetricEvaluationList);
                when(qualityFactorsDomainController.getSingleFactorEvaluation(factorId, projectExternalId))
                                .thenReturn(factorEvaluation);
                ...
                verify(metricsDomainController, times(1)).getMetricsForQualityFactorCurrentEvaluation(factorId,
                                projectExternalId);
                verify(metricsDomainController, times(1)).getMetricsPrediction(dtoMetricEvaluationList,
                                projectExternalId, technique, freq, horizon);
                verifyNoMoreInteractions(metricsDomainController);
                verify(qualityFactorsDomainController, times(1)).getSingleFactorEvaluation(factorId, projectExternalId);
                verifyNoMoreInteractions(qualityFactorsDomainController);
        }
        ...
        public void getQualityFactorsHistoricalData() throws Exception {
                ...
                when(qualityFactorsDomainController.getAllFactorsHistoricalEvaluation(projectExternalId, null, fromDate,
                                toDate)).thenReturn(dtoFactorEvaluationList);
                ...
                // Verify mock interactions
                verify(qualityFactorsDomainController, times(1)).getAllFactorsHistoricalEvaluation(projectExternalId,
        ...
        public void getQualityFactorsHistoricalDataReadError() throws Exception {
                ...
                LocalDate toDate = LocalDate.parse(to);
                when(qualityFactorsDomainController.getAllFactorsHistoricalEvaluation(projectExternalId, null, fromDate,
                                toDate)).thenThrow(new IOException());
        ...
        public void getQualityFactorsPredictionData() throws Exception {
                ...
                when(qualityFactorsDomainController.getAllFactorsEvaluation(projectExternalId, null, true))
                                .thenReturn(dtoFactorEvaluationList);
                when(qualityFactorsDomainController.getFactorsPrediction(dtoFactorEvaluationList, projectExternalId,
                                technique, freq, horizon)).thenReturn(dtoFactorEvaluationList);
                ...
                // Verify mock interactions
                verify(qualityFactorsDomainController, times(1)).getAllFactorsEvaluation(projectExternalId, null, true);
                verify(qualityFactorsDomainController, times(1)).getFactorsPrediction(dtoFactorEvaluationList,
                                projectExternalId, technique, freq, horizon);
                verifyNoMoreInteractions(qualityFactorsDomainController);
        }
        ...
        public void getAllQualityFactors() throws Exception {
                ...
                when(qualityFactorsDomainController.getQualityFactorsByProjectAndProfile(projectExternalId, null))
                                .thenReturn(qualityFactorList);
                ...
                // Verify mock interactions
                verify(qualityFactorsDomainController, times(1)).getQualityFactorsByProjectAndProfile(projectExternalId,
                                null);
                verifyNoMoreInteractions(qualityFactorsDomainController);
        }
        ...
        public void getQualityFactor() throws Exception {
                ...
                this.mockMvc.perform(requestBuilder)
                                ...
                                .andExpect(jsonPath("$.categoryName", is(factor.getCategoryName())))
                                .andExpect(jsonPath("$.threshold",
                                                is(Double.valueOf(factor.getThreshold().toString()))))
        ...
        public void getMissingQualityFactor() throws Exception {
                ...
                when(qualityFactorsDomainController.getQualityFactorById(qualityFactorId))
                                .thenThrow(new QualityFactorNotFoundException(qualityFactorId.toString()));
        ...
        public void newQualityFactor() throws Exception {
                ...
                Factor factor = domainObjectsBuilder.buildFactor(project);
                when(qualityFactorsDomainController.assessQualityFactor(factor.getName(),
                                factor.getProject().getExternalId())).thenReturn(true);
                ...
                RequestBuilder requestBuilder = MockMvcRequestBuilders
                                ...
                                .param("category", factor.getCategoryName())
                ...
                verify(qualityFactorsDomainController, times(1)).saveQualityFactorWithCategory(eq(factor.getName()),
                                eq(factor.getDescription()), eq(factor.getThreshold().toString()),
                                eq(factor.getMetrics()), eq(factor.getType()), eq(factor.getCategoryName()),
                                eq(project));
                verify(qualityFactorsDomainController, times(1)).assessQualityFactor(factor.getName(),
                                factor.getProject().getExternalId());
                verifyNoMoreInteractions(qualityFactorsDomainController);
        }
        ...
        public void newQualityFactorAssessmentError() throws Exception {
                ...
                Factor factor = domainObjectsBuilder.buildFactor(project);
                when(qualityFactorsDomainController.assessQualityFactor(factor.getName(),
                                factor.getProject().getExternalId())).thenReturn(false);
        ...
        public void editQualityFactor() throws Exception {
                ...
                when(qualityFactorsDomainController.getQualityFactorById(factor.getId())).thenReturn(factor);
                when(qualityFactorsDomainController.assessQualityFactor(factor.getName(), project.getExternalId()))
                                .thenReturn(true);
                ...
                // Verify mock interactions
                verify(qualityFactorsDomainController, times(1)).getQualityFactorById(factor.getId());
                verify(qualityFactorsDomainController, times(1)).editQualityFactorWithCategory(eq(factor.getId()),
                                eq(factor.getName()), eq(factor.getDescription()), eq(factor.getThreshold().toString()),
                                eq(factor.getWeights()), eq(factor.getType()), eq(factor.getCategoryName()));
                verify(qualityFactorsDomainController, times(1)).assessQualityFactor(factor.getName(),
                                factor.getProject().getExternalId());
                verifyNoMoreInteractions(qualityFactorsDomainController);
        }
        ...
        @Test
        public void editQualityFactorIntegrityViolation()
                ...
                when(qualityFactorsDomainController.editQualityFactorWithCategory(eq(factor.getId()),
                                eq(factor.getName()), eq(factor.getDescription()), eq(factor.getThreshold().toString()),
                                eq(factor.getMetrics()), eq(factor.getType()), eq(factor.getCategoryName())))
