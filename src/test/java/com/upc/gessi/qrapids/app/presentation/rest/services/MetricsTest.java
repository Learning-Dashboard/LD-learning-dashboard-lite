...
public class MetricsTest {
                ...
                this.mockMvc.perform(requestBuilder)
                                ...
                                .andExpect(jsonPath("$[0].upperThreshold",
                                                is(HelperFunctions.getFloatAsDouble(
                                                                metricCategoryList.get(0).getUpperThreshold()))))
                                ...
                                .andExpect(jsonPath("$[1].upperThreshold",
                                                is(HelperFunctions.getFloatAsDouble(
                                                                metricCategoryList.get(1).getUpperThreshold()))))
                                ...
                                .andExpect(jsonPath("$[2].upperThreshold",
                                                is(HelperFunctions.getFloatAsDouble(
                                                                metricCategoryList.get(2).getUpperThreshold()))))
        ...
        public void newMetricsCategoriesNotEnough() throws Exception {
                ...
                RequestBuilder requestBuilder = MockMvcRequestBuilders
                                .post("/api/metrics/categories")
                                .param("name", "Default")
                                .param("patternGroup", "testPattern")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(gson.toJson(metricRawCategoriesList));
                ...
                // Verify mock interactions
                verify(metricsDomainController, times(1)).newMetricCategories(metricRawCategoriesList, "Default", "testPattern");
                verifyNoMoreInteractions(metricsDomainController);
        }
        ...
        public void getMetricsEvaluations() throws Exception {
                // Given
                when(metricsDomainController.getAllMetricsCurrentEvaluation(projectExternalId, null))
        ...
        public void getSingleMetricEvaluation() throws Exception {
                // Given
                when(metricsDomainController.getSingleMetricCurrentEvaluation(dtoMetricEvaluation.getId(),
                                projectExternalId)).thenReturn(dtoMetricEvaluation);
                ...
                // Verify mock interactions
                verify(metricsDomainController, times(1)).getSingleMetricCurrentEvaluation(dtoMetricEvaluation.getId(),
                                projectExternalId);
                verifyNoMoreInteractions(metricsDomainController);
        }
        ...
        public void getMetricsHistoricalData() throws Exception {
                ...
                when(metricsDomainController.getAllMetricsHistoricalEvaluation(projectExternalId, null,
                ...
                // Verify mock interactions
                verify(metricsDomainController, times(1)).getAllMetricsHistoricalEvaluation(projectExternalId, null,
                                LocalDate.parse(dateFrom), LocalDate.parse(dateTo));
                verifyNoMoreInteractions(metricsDomainController);
        }
        ...
        public void getHistoricalDataForMetric() throws Exception {
                ...
                String dateFrom = "2019-07-07";
                String dateTo = "2019-07-15";
                when(metricsDomainController.getSingleMetricHistoricalEvaluation(dtoMetricEvaluation.getId(),
                                projectExternalId, null, LocalDate.parse(dateFrom), LocalDate.parse(dateTo)))
                                .thenReturn(dtoMetricEvaluationList);
                ...
                // Verify mock interactions
                verify(metricsDomainController, times(1)).getSingleMetricHistoricalEvaluation(
                                dtoMetricEvaluation.getId(), projectExternalId, null, LocalDate.parse(dateFrom),
                ...
                this.mockMvc.perform(requestBuilder)
                                ...
                                .andDo(document("metrics/prediction",
                                                ...
                                                responseFields(
                                                                ...
                                                                .description("List of the quality factors that use this metric"),
                                                fieldWithPath("[].scope")
                                                                .description("Scope of the metric (e.g., 'system')"))));
