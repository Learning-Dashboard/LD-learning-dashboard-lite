...
public class ProductsTest {
        ...
        public void getProducts() throws Exception {
                ...
                DTOProduct dtoProduct = new DTOProduct(productId, productName, productDescription, null,
                                dtoProjectList);
        ...
        public void updateProduct() throws Exception {
                ...
                String productName = "Test";
                String productDescription = "Test product";
                // getResource() : The name of a resource is a '/'-separated path name that
                // identifies the resource.
                URL projectImageUrl = QrapidsApplication.class.getClassLoader()
                                .getResource("static" + "/" + "icons" + "/" + "projectDefault.jpg");
                File file = new File(URLDecoder.decode(projectImageUrl.getPath(), "UTF-8"));
                MockMultipartFile logoMultipartFile = new MockMultipartFile("logo", "logo.jpg", "image/jpeg",
                ...
                verify(productsController, times(1)).updateProduct(productId, productName, productDescription,
                                logoMultipartFile.getBytes(), projectIds);
        ...
        public void newProduct() throws Exception {
                ...
                verify(productsController, times(1)).newProduct(productName, productDescription,
                                logoMultipartFile.getBytes(), projectIds);
        ...
        public void getProductEvaluation() throws Exception {
                ...
                Pair<Float, String> strategicIndicatorValuePair = Pair.of(strategicIndicatorValue,
                ...
                DTOStrategicIndicatorEvaluation dtoStrategicIndicatorEvaluation = new DTOStrategicIndicatorEvaluation(
                                ...
                                strategicIndicatorValuePair, strategicIndicatorRationale, dtoSIAssessmentList, date,
                                datasource, strategicIndicatorDbId, categoriesDescription, false);
                ...
                when(productsController.getProductEvaluation(productId))
        ...
        public void getDetailedCurrentEvaluation() throws Exception {
                ...
                Pair<String, List<DTOStrategicIndicatorEvaluation>> productStrategicIndicatorsEvaluation = Pair
                                .of(projectName, dtoStrategicIndicatorEvaluationList);
                ...
                this.mockMvc.perform(requestBuilder)
                                ...
                                .andExpect(jsonPath("$[0].second[0].dbId",
                                                is(dtoStrategicIndicatorEvaluation.getDbId().intValue())))
                                .andExpect(jsonPath("$[0].second[0].name",
                                                is(dtoStrategicIndicatorEvaluation.getName())))
                                .andExpect(jsonPath("$[0].second[0].description",
                                                is(dtoStrategicIndicatorEvaluation.getDescription())))
                                .andExpect(jsonPath("$[0].second[0].value.first",
                                                is(getFloatAsDouble(dtoStrategicIndicatorEvaluation.getValue()
                                                                .getFirst()))))
                                .andExpect(jsonPath("$[0].second[0].value.second",
                                                is(dtoStrategicIndicatorEvaluation.getValue().getSecond())))
                                .andExpect(jsonPath("$[0].second[0].confidence80", is(nullValue())))
                                .andExpect(jsonPath("$[0].second[0].confidence95", is(nullValue())))
                                .andExpect(jsonPath("$[0].second[0].value_description",
                                                is(dtoStrategicIndicatorEvaluation.getValue_description())))
                                .andExpect(jsonPath("$[0].second[0].rationale",
                                                is(dtoStrategicIndicatorEvaluation.getRationale())))
                                .andExpect(jsonPath("$[0].second[0].probabilities", hasSize(3)))
                                .andExpect(jsonPath("$[0].second[0].probabilities[0].id",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(0).getId()
                                                                .intValue())))
                                .andExpect(jsonPath("$[0].second[0].probabilities[0].label",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(0)
                                                                .getLabel())))
                                .andExpect(jsonPath("$[0].second[0].probabilities[0].value",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(0)
                                                                .getValue())))
                                .andExpect(jsonPath("$[0].second[0].probabilities[0].color",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(0)
                                                                .getColor())))
                                .andExpect(jsonPath("$[0].second[0].probabilities[0].upperThreshold",
                                                is(getFloatAsDouble(dtoStrategicIndicatorEvaluation.getProbabilities()
                                                                .get(0).getUpperThreshold()))))
                                .andExpect(jsonPath("$[0].second[0].probabilities[1].id",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(1).getId()
                                                                .intValue())))
                                .andExpect(jsonPath("$[0].second[0].probabilities[1].label",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(1)
                                                                .getLabel())))
                                .andExpect(jsonPath("$[0].second[0].probabilities[1].value",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(1)
                                                                .getValue())))
                                .andExpect(jsonPath("$[0].second[0].probabilities[1].color",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(1)
                                                                .getColor())))
                                .andExpect(jsonPath("$[0].second[0].probabilities[1].upperThreshold",
                                                is(getFloatAsDouble(dtoStrategicIndicatorEvaluation.getProbabilities()
                                                                .get(1).getUpperThreshold()))))
                                .andExpect(jsonPath("$[0].second[0].probabilities[2].id",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(2).getId()
                                                                .intValue())))
                                .andExpect(jsonPath("$[0].second[0].probabilities[2].label",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(2)
                                                                .getLabel())))
                                .andExpect(jsonPath("$[0].second[0].probabilities[2].value",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(2)
                                                                .getValue())))
                                .andExpect(jsonPath("$[0].second[0].probabilities[2].color",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(2)
                                                                .getColor())))
                                .andExpect(jsonPath("$[0].second[0].probabilities[2].upperThreshold",
                                                is(getFloatAsDouble(dtoStrategicIndicatorEvaluation.getProbabilities()
                                                                .get(2).getUpperThreshold()))))
                                .andExpect(jsonPath("$[0].second[0].date[0]",
                                                is(dtoStrategicIndicatorEvaluation.getDate().getYear())))
                                .andExpect(jsonPath("$[0].second[0].date[1]",
                                                is(dtoStrategicIndicatorEvaluation.getDate().getMonthValue())))
                                .andExpect(jsonPath("$[0].second[0].date[2]",
                                                is(dtoStrategicIndicatorEvaluation.getDate().getDayOfMonth())))
                                .andExpect(jsonPath("$[0].second[0].datasource",
                                                is(dtoStrategicIndicatorEvaluation.getDatasource())))
                                .andExpect(jsonPath("$[0].second[0].categories_description",
                                                is(dtoStrategicIndicatorEvaluation.getCategories_description())))
                                .andExpect(jsonPath("$[0].second[0].hasBN",
                                                is(dtoStrategicIndicatorEvaluation.isHasBN())))
                                .andExpect(jsonPath("$[0].second[0].hasFeedback",
                                                is(dtoStrategicIndicatorEvaluation.isHasFeedback())))
                                .andExpect(jsonPath("$[0].second[0].forecastingError",
                                                is(dtoStrategicIndicatorEvaluation.getForecastingError())))
