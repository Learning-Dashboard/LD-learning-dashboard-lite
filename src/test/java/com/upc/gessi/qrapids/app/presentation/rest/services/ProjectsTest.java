...
public class ProjectsTest {
        ...
        public void getProjectsCategoriesConflict() throws Exception {
                when(projectsDomainController.importProjectsAndUpdateDatabase())
                                .thenThrow(new CategoriesException(Messages.CATEGORIES_DO_NOT_MATCH));
        ...
        public void getProjects() throws Exception {
                ...
                DTOProject dtoProject = new DTOProject(projectId, projectExternalId, projectName, projectDescription,
                                null, active, projectBacklogId, false, dtoProjectIdentities, anonymized, null);
                ...
                this.mockMvc.perform(requestBuilder)
                                ...
                                .andExpect(jsonPath("$[0].identities.GITHUB.dataSource",
        ...
        public void updateProject() throws Exception {
                ...
                MockMultipartFile logoMultipartFile = new MockMultipartFile("file", "logo.jpg", "image/jpeg",
                                "logo".getBytes());
                ...
                DTOProject dtoProject = new DTOProject(projectId, projectExternalId, projectName, projectDescription,
                                logoMultipartFile.getBytes(), true, projectBacklogId, false, dtoProjectIdentities,
                                anonymized, null);

                DTOUpdateProject dtoUpdateProject = new DTOUpdateProject(projectExternalId, projectName,
                                projectDescription, projectBacklogId, dtoProjectIdentitiesBody, isGlobal);
                ...
                dtoProject.getIdentities().values().forEach(identity -> {
                        DTOProjectIdentity argumentIdentity = argument.getValue().getIdentities()
                                        .get(identity.getDataSource());
        ...
        public void updateProjectBadRequest() throws Exception {
                ...
                MockMultipartFile jsonFile = new MockMultipartFile("no-data", "", "application/json",
                                requestJson.getBytes());
        ...
        public void getNextMilestones() throws Exception {
                ...
                when(projectsDomainController.getMilestonesForProject(eq(projectExternalId), eq(now)))
                                .thenReturn(milestoneList);
        ...
        public void getAllMilestones() throws Exception {
                ...
                when(projectsDomainController.getMilestonesForProject(projectExternalId, null))
                                .thenReturn(milestoneList);
        ...
        public void anonymizeProjectsConflict() throws Exception {
                ...
                when(projectsDomainController.anonymizeProjects(any(), any()))
                                .thenThrow(ProjectAlreadyAnonymizedException.class);
