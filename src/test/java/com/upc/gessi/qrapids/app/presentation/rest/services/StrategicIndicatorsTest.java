...
public class StrategicIndicatorsTest {
        ...
        public void setUp() {
                ...
                dtoDetailedStrategicIndicator = new DTODetailedStrategicIndicatorEvaluation(
                                dtoStrategicIndicatorEvaluation.getId(), dtoStrategicIndicatorEvaluation.getName(),
                                dtoFactorList);
        ...
        public void getStrategicIndicatorsCurrentEvaluation() throws Exception {
                // Given
                when(strategicIndicatorsDomainController.getAllStrategicIndicatorsCurrentEvaluation(projectExternalId,
                                profileId)).thenReturn(dtoStrategicIndicatorEvaluationList); // profileId = null -->
                                                                                             // without profile
                ...
                this.mockMvc.perform(requestBuilder)
                                ...
                                .andExpect(jsonPath("$[0].dbId",
                                                is(dtoStrategicIndicatorEvaluation.getDbId().intValue())))
                                .andExpect(jsonPath("$[0].name", is(dtoStrategicIndicatorEvaluation.getName())))
                                .andExpect(jsonPath("$[0].description",
                                                is(dtoStrategicIndicatorEvaluation.getDescription())))
                                .andExpect(jsonPath("$[0].value.first",
                                                is(getFloatAsDouble(dtoStrategicIndicatorEvaluation.getValue()
                                                                .getFirst()))))
                                .andExpect(jsonPath("$[0].value.second",
                                                is(dtoStrategicIndicatorEvaluation.getValue().getSecond())))
                                .andExpect(jsonPath("$[0].confidence80", is(nullValue())))
                                .andExpect(jsonPath("$[0].confidence95", is(nullValue())))
                                .andExpect(jsonPath("$[0].value_description",
                                                is(dtoStrategicIndicatorEvaluation.getValue_description())))
                                .andExpect(jsonPath("$[0].rationale",
                                                is(dtoStrategicIndicatorEvaluation.getRationale())))
                                .andExpect(jsonPath("$[0].probabilities", hasSize(3)))
                                .andExpect(jsonPath("$[0].probabilities[0].id",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(0).getId()
                                                                .intValue())))
                                .andExpect(jsonPath("$[0].probabilities[0].label",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(0)
                                                                .getLabel())))
                                .andExpect(jsonPath("$[0].probabilities[0].value",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(0)
                                                                .getValue())))
                                .andExpect(jsonPath("$[0].probabilities[0].color",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(0)
                                                                .getColor())))
                                .andExpect(jsonPath("$[0].probabilities[0].upperThreshold",
                                                is(getFloatAsDouble(dtoStrategicIndicatorEvaluation.getProbabilities()
                                                                .get(0).getUpperThreshold()))))
                                .andExpect(jsonPath("$[0].probabilities[1].id",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(1).getId()
                                                                .intValue())))
                                .andExpect(jsonPath("$[0].probabilities[1].label",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(1)
                                                                .getLabel())))
                                .andExpect(jsonPath("$[0].probabilities[1].value",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(1)
                                                                .getValue())))
                                .andExpect(jsonPath("$[0].probabilities[1].color",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(1)
                                                                .getColor())))
                                .andExpect(jsonPath("$[0].probabilities[1].upperThreshold",
                                                is(getFloatAsDouble(dtoStrategicIndicatorEvaluation.getProbabilities()
                                                                .get(1).getUpperThreshold()))))
                                .andExpect(jsonPath("$[0].probabilities[2].id",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(2).getId()
                                                                .intValue())))
                                .andExpect(jsonPath("$[0].probabilities[2].label",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(2)
                                                                .getLabel())))
                                .andExpect(jsonPath("$[0].probabilities[2].value",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(2)
                                                                .getValue())))
                                .andExpect(jsonPath("$[0].probabilities[2].color",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(2)
                                                                .getColor())))
                                .andExpect(jsonPath("$[0].probabilities[2].upperThreshold",
                                                is(getFloatAsDouble(dtoStrategicIndicatorEvaluation.getProbabilities()
                                                                .get(2).getUpperThreshold()))))
                                .andExpect(jsonPath("$[0].date[0]",
                                                is(dtoStrategicIndicatorEvaluation.getDate().getYear())))
                                .andExpect(jsonPath("$[0].date[1]",
                                                is(dtoStrategicIndicatorEvaluation.getDate().getMonthValue())))
                                .andExpect(jsonPath("$[0].date[2]",
                                                is(dtoStrategicIndicatorEvaluation.getDate().getDayOfMonth())))
                                .andExpect(jsonPath("$[0].datasource",
                                                is(dtoStrategicIndicatorEvaluation.getDatasource())))
                                .andExpect(jsonPath("$[0].categories_description",
                                                is(dtoStrategicIndicatorEvaluation.getCategories_description())))
                                .andExpect(jsonPath("$[0].hasBN", is(dtoStrategicIndicatorEvaluation.isHasBN())))
                                .andExpect(jsonPath("$[0].hasFeedback",
                                                is(dtoStrategicIndicatorEvaluation.isHasFeedback())))
                                .andExpect(jsonPath("$[0].forecastingError",
                                                is(dtoStrategicIndicatorEvaluation.getForecastingError())))
                ...
                verify(strategicIndicatorsDomainController, times(1))
                                .getAllStrategicIndicatorsCurrentEvaluation(projectExternalId, profileId); // profileId
                                                                                                           // = null -->
                                                                                                           // without
                                                                                                           // profile
        ...
        public void getStrategicIndicatorsCurrentEvaluationCategoriesConflict() throws Exception {
                // Given
                when(strategicIndicatorsDomainController.getAllStrategicIndicatorsCurrentEvaluation(projectExternalId,
                                profileId)).thenThrow(new CategoriesException(Messages.CATEGORIES_DO_NOT_MATCH));
        ...
        public void getStrategicIndicatorsCurrentEvaluationReadError() throws Exception {
                // Given
                when(strategicIndicatorsDomainController.getAllStrategicIndicatorsCurrentEvaluation(projectExternalId,
                                profileId)).thenThrow(new IOException());
        ...
        public void getSingleStrategicIndicatorCurrentEvaluation() throws Exception {
                ...
                when(strategicIndicatorsDomainController.getSingleStrategicIndicatorsCurrentEvaluation(
                                dtoStrategicIndicatorEvaluation.getId(),
                                projectExternalId, profileId)).thenReturn(dtoStrategicIndicatorEvaluation); // profileId
                                                                                                            // = null
                                                                                                            // -->
                                                                                                            // without
                                                                                                            // profile
                ...
                this.mockMvc.perform(requestBuilder)
                                ...
                                .andExpect(jsonPath("$.description",
                                                is(dtoStrategicIndicatorEvaluation.getDescription())))
                                .andExpect(jsonPath("$.value.first",
                                                is(getFloatAsDouble(dtoStrategicIndicatorEvaluation.getValue()
                                                                .getFirst()))))
                                .andExpect(jsonPath("$.value.second",
                                                is(dtoStrategicIndicatorEvaluation.getValue().getSecond())))
                                .andExpect(jsonPath("$.confidence80", is(nullValue())))
                                .andExpect(jsonPath("$.confidence95", is(nullValue())))
                                .andExpect(jsonPath("$.value_description",
                                                is(dtoStrategicIndicatorEvaluation.getValue_description())))
                                .andExpect(jsonPath("$.rationale", is(dtoStrategicIndicatorEvaluation.getRationale())))
                                .andExpect(jsonPath("$.probabilities", hasSize(3)))
                                .andExpect(jsonPath("$.probabilities[0].id",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(0).getId()
                                                                .intValue())))
                                .andExpect(jsonPath("$.probabilities[0].label",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(0)
                                                                .getLabel())))
                                .andExpect(jsonPath("$.probabilities[0].value",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(0)
                                                                .getValue())))
                                .andExpect(jsonPath("$.probabilities[0].color",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(0)
                                                                .getColor())))
                                .andExpect(jsonPath("$.probabilities[0].upperThreshold",
                                                is(getFloatAsDouble(dtoStrategicIndicatorEvaluation.getProbabilities()
                                                                .get(0).getUpperThreshold()))))
                                .andExpect(jsonPath("$.probabilities[1].id",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(1).getId()
                                                                .intValue())))
                                .andExpect(jsonPath("$.probabilities[1].label",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(1)
                                                                .getLabel())))
                                .andExpect(jsonPath("$.probabilities[1].value",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(1)
                                                                .getValue())))
                                .andExpect(jsonPath("$.probabilities[1].color",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(1)
                                                                .getColor())))
                                .andExpect(jsonPath("$.probabilities[1].upperThreshold",
                                                is(getFloatAsDouble(dtoStrategicIndicatorEvaluation.getProbabilities()
                                                                .get(1).getUpperThreshold()))))
                                .andExpect(jsonPath("$.probabilities[2].id",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(2).getId()
                                                                .intValue())))
                                .andExpect(jsonPath("$.probabilities[2].label",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(2)
                                                                .getLabel())))
                                .andExpect(jsonPath("$.probabilities[2].value",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(2)
                                                                .getValue())))
                                .andExpect(jsonPath("$.probabilities[2].color",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(2)
                                                                .getColor())))
                                .andExpect(jsonPath("$.probabilities[2].upperThreshold",
                                                is(getFloatAsDouble(dtoStrategicIndicatorEvaluation.getProbabilities()
                                                                .get(2).getUpperThreshold()))))
                                .andExpect(jsonPath("$.date[0]",
                                                is(dtoStrategicIndicatorEvaluation.getDate().getYear())))
                                .andExpect(jsonPath("$.date[1]",
                                                is(dtoStrategicIndicatorEvaluation.getDate().getMonthValue())))
                                .andExpect(jsonPath("$.date[2]",
                                                is(dtoStrategicIndicatorEvaluation.getDate().getDayOfMonth())))
                                .andExpect(jsonPath("$.datasource",
                                                is(dtoStrategicIndicatorEvaluation.getDatasource())))
                                .andExpect(jsonPath("$.categories_description",
                                                is(dtoStrategicIndicatorEvaluation.getCategories_description())))
                                .andExpect(jsonPath("$.hasBN", is(dtoStrategicIndicatorEvaluation.isHasBN())))
                                .andExpect(jsonPath("$.hasFeedback",
                                                is(dtoStrategicIndicatorEvaluation.isHasFeedback())))
                                .andExpect(jsonPath("$.forecastingError",
                                                is(dtoStrategicIndicatorEvaluation.getForecastingError())))
                ...
                // Verify mock interactions
                verify(strategicIndicatorsDomainController, times(1)).getSingleStrategicIndicatorsCurrentEvaluation(
                                dtoStrategicIndicatorEvaluation.getId(), projectExternalId, profileId);
                verifyNoMoreInteractions(strategicIndicatorsDomainController);
        }
        ...
        public void getSingleStrategicIndicatorCurrentEvaluationCategoriesConflict() throws Exception {
                ...
                when(strategicIndicatorsDomainController.getSingleStrategicIndicatorsCurrentEvaluation(
                                dtoStrategicIndicatorEvaluation.getId(), projectExternalId, profileId))
                                .thenThrow(new CategoriesException(Messages.NOT_ENOUGH_CATEGORIES));
        ...
        public void getStrategicIndicatorsHistoricalData() throws Exception {
                ...
                when(strategicIndicatorsDomainController.getAllStrategicIndicatorsHistoricalEvaluation(
                                projectExternalId, profileId, fromDate, toDate))
                                .thenReturn(dtoStrategicIndicatorEvaluationList);
                ...
                // Verify mock interactions
                verify(strategicIndicatorsDomainController, times(1)).getAllStrategicIndicatorsHistoricalEvaluation(
                                projectExternalId, profileId, fromDate, toDate);
                verifyNoMoreInteractions(strategicIndicatorsDomainController);
        }
        ...
        public void getStrategicIndicatorsHistoricalDataReadError() throws Exception {
                ...
                LocalDate toDate = LocalDate.parse(to);
                when(strategicIndicatorsDomainController.getAllStrategicIndicatorsHistoricalEvaluation(
                                projectExternalId, profileId, fromDate, toDate)).thenThrow(new IOException());
        ...
        public void getDetailedStrategicIndicatorsCurrentEvaluation() throws Exception {
                // Given
                when(strategicIndicatorsDomainController
                                .getAllDetailedStrategicIndicatorsCurrentEvaluation(projectExternalId, profileId, true))
                                .thenReturn(dtoDetailedStrategicIndicatorList);
                ...
                this.mockMvc.perform(requestBuilder)
                                ...
                                .andExpect(jsonPath("$[0].date[0]",
                                                is(dtoDetailedStrategicIndicator.getDate().getYear())))
                                .andExpect(jsonPath("$[0].date[1]",
                                                is(dtoDetailedStrategicIndicator.getDate().getMonthValue())))
                                .andExpect(jsonPath("$[0].date[2]",
                                                is(dtoDetailedStrategicIndicator.getDate().getDayOfMonth())))
                                .andExpect(jsonPath("$[0].value.first",
                                                is(getFloatAsDouble(
                                                                dtoDetailedStrategicIndicator.getValue().getFirst()))))
                                .andExpect(jsonPath("$[0].value.second",
                                                is(dtoDetailedStrategicIndicator.getValue().getSecond())))
                                .andExpect(jsonPath("$[0].value_description",
                                                is(dtoDetailedStrategicIndicator.getValue_description())))
                                .andExpect(jsonPath("$[0].mismatchDays", is(0)))
                                .andExpect(jsonPath("$[0].missingFactors", is(nullValue())))
                                .andExpect(jsonPath("$[0].factors",
                                                hasSize(dtoDetailedStrategicIndicator.getFactors().size())))
                                ...
                                .andExpect(jsonPath("$[0].factors[0].description",
                                                is(dtoFactorEvaluation.getDescription())))
                                .andExpect(jsonPath("$[0].factors[0].value.first",
                                                is(getFloatAsDouble(dtoFactorEvaluation.getValue().getFirst()))))
                                .andExpect(jsonPath("$[0].factors[0].value.second",
                                                is(dtoFactorEvaluation.getValue().getSecond())))
                                .andExpect(jsonPath("$[0].factors[0].value_description",
                                                is(dtoFactorEvaluation.getValue_description())))
                                .andExpect(jsonPath("$[0].factors[0].date[0]",
                                                is(dtoFactorEvaluation.getDate().getYear())))
                                .andExpect(jsonPath("$[0].factors[0].date[1]",
                                                is(dtoFactorEvaluation.getDate().getMonthValue())))
                                .andExpect(jsonPath("$[0].factors[0].date[2]",
                                                is(dtoFactorEvaluation.getDate().getDayOfMonth())))
                                .andExpect(jsonPath("$[0].factors[0].datasource",
                                                is(dtoFactorEvaluation.getDatasource())))
                                .andExpect(jsonPath("$[0].factors[0].rationale",
                                                is(dtoFactorEvaluation.getRationale())))
                                .andExpect(jsonPath("$[0].factors[0].confidence80",
                                                is(dtoFactorEvaluation.getConfidence80())))
                                .andExpect(jsonPath("$[0].factors[0].confidence95",
                                                is(dtoFactorEvaluation.getConfidence95())))
                                .andExpect(jsonPath("$[0].factors[0].forecastingError",
                                                is(dtoFactorEvaluation.getForecastingError())))
                                .andExpect(jsonPath("$[0].factors[0].mismatchDays", is(0)))
                                .andExpect(jsonPath("$[0].factors[0].missingMetrics", is(nullValue())))
                                .andExpect(jsonPath("$[0].factors[0].strategicIndicators[0]",
                                                is(dtoFactorEvaluation.getStrategicIndicators().get(0))))
                                .andExpect(jsonPath("$[0].factors[0].formattedDate",
                                                is(dtoFactorEvaluation.getDate().toString())))
                                .andExpect(jsonPath("$[0].factors[0].type", is(nullValue())))
        ...
        public void getSingleDetailedStrategicIndicator() throws Exception {
                when(strategicIndicatorsDomainController.getSingleDetailedStrategicIndicatorCurrentEvaluation(
                                dtoDetailedStrategicIndicator.getId(), projectExternalId, profileId))
                                .thenReturn(dtoDetailedStrategicIndicatorList);

                // Perform request
                RequestBuilder requestBuilder = RestDocumentationRequestBuilders
                                .get("/api/strategicIndicators/{id}/qualityFactors/current",
                                                dtoDetailedStrategicIndicator.getId())
                                .param("prj", projectExternalId);
                ...
                // Verify mock interactions
                verify(strategicIndicatorsDomainController, times(1))
                                .getSingleDetailedStrategicIndicatorCurrentEvaluation(
                                                dtoDetailedStrategicIndicator.getId(), projectExternalId, profileId);
                verifyNoMoreInteractions(strategicIndicatorsDomainController);
        }
        ...
        public void getDetailedStrategicIndicatorsHistoricalData() throws Exception {
                ...
                String to = "2019-07-15";
                LocalDate toDate = LocalDate.parse(to);
                when(strategicIndicatorsDomainController.getAllDetailedStrategicIndicatorsHistoricalEvaluation(
                                projectExternalId, profileId, fromDate, toDate))
                                .thenReturn(dtoDetailedStrategicIndicatorList);
                ...
                // Verify mock interactions
                verify(strategicIndicatorsDomainController, times(1))
                                .getAllDetailedStrategicIndicatorsHistoricalEvaluation(projectExternalId, profileId,
                                                fromDate, toDate);
                verifyNoMoreInteractions(strategicIndicatorsDomainController);
        }
        ...
        public void getDetailedSingleStrategicIndicatorHistoricalData() throws Exception {
                ...
                String to = "2019-07-15";
                LocalDate toDate = LocalDate.parse(to);
                when(strategicIndicatorsDomainController.getSingleDetailedStrategicIndicatorsHistoricalEvaluation(
                                dtoDetailedStrategicIndicator.getId(), projectExternalId, profileId, fromDate, toDate))
                                .thenReturn(dtoDetailedStrategicIndicatorList);

                // Perform request
                RequestBuilder requestBuilder = RestDocumentationRequestBuilders
                                .get("/api/strategicIndicators/{id}/qualityFactors/historical",
                                                dtoDetailedStrategicIndicator.getId())
                                .param("prj", projectExternalId)
                                .param("from", from)
                                .param("to", to);
                ...
                // Verify mock interactions
                verify(strategicIndicatorsDomainController, times(1))
                                .getSingleDetailedStrategicIndicatorsHistoricalEvaluation(
                                                dtoDetailedStrategicIndicator.getId(), projectExternalId, profileId,
                                                fromDate, toDate);
        ...
        public void getDetailedStrategicIndicatorPredictionData() throws Exception {
                ...
                String horizon = "7";
                String freq = "7";
                when(strategicIndicatorsDomainController.getDetailedStrategicIndicatorsPrediction(anyList(),
                                eq(technique), eq(freq), eq(horizon), eq(projectExternalId)))
                                .thenReturn(dtoDetailedStrategicIndicatorList);
                ...
                verify(strategicIndicatorsDomainController, times(1))
                                .getAllDetailedStrategicIndicatorsCurrentEvaluation(projectExternalId, profileId, true);
                verify(strategicIndicatorsDomainController, times(1)).getDetailedStrategicIndicatorsPrediction(
                                anyList(), eq(technique), eq(freq), eq(horizon), eq(projectExternalId));
                verifyNoMoreInteractions(strategicIndicatorsDomainController);
        }
        ...
        public void getSingleDetailedStrategicIndicatorPredictionData() throws Exception {
                ...
                // Perform request
                RequestBuilder requestBuilder = RestDocumentationRequestBuilders
                                .get("/api/strategicIndicators/{id}/qualityFactors/prediction",
                                                dtoDetailedStrategicIndicator.getId())
                                .param("prj", projectExternalId)
                                .param("technique", technique)
                                .param("horizon", horizon);
        ...
        public void getStrategicIndicatorsPrediction() throws Exception {
                ...
                when(strategicIndicatorsDomainController.getAllStrategicIndicatorsCurrentEvaluation(projectExternalId,
                                profileId)).thenReturn(dtoStrategicIndicatorEvaluationList);
                when(strategicIndicatorsDomainController.getStrategicIndicatorsPrediction(
                                dtoStrategicIndicatorEvaluationList, technique, freq, horizon, projectExternalId))
                                .thenReturn(dtoStrategicIndicatorEvaluationList);
                ...
                // Verify mock interactions
                verify(strategicIndicatorsDomainController, times(1))
                                .getAllStrategicIndicatorsCurrentEvaluation(projectExternalId, profileId);
                verify(strategicIndicatorsDomainController, times(1)).getStrategicIndicatorsPrediction(
                                dtoStrategicIndicatorEvaluationList, technique, freq, horizon, projectExternalId);
                verifyNoMoreInteractions(strategicIndicatorsDomainController);
        }
        ...
        public void getQualityFactorsEvaluationsForOneStrategicIndicator() throws Exception {
                ...
                when(qualityFactorsDomainController.getFactorsWithMetricsForOneStrategicIndicatorCurrentEvaluation(
                                strategicIndicatorId, projectExternalId)).thenReturn(dtoDetailedFactorEvaluationList);

                // Perform request
                RequestBuilder requestBuilder = RestDocumentationRequestBuilders
                                .get("/api/strategicIndicators/{id}/qualityFactors/metrics/current",
                ...
                this.mockMvc.perform(requestBuilder)
                                ...
                                .andExpect(jsonPath("$[0].description",
                                                is(dtoDetailedFactorEvaluation.getDescription())))
                                ...
                                .andExpect(jsonPath("$[0].value_description",
                                                is(dtoDetailedFactorEvaluation.getValue_description())))
                                .andExpect(jsonPath("$[0].mismatchDays", is(0)))
                                .andExpect(jsonPath("$[0].missingMetrics", is(nullValue())))
                                .andExpect(jsonPath("$[0].metrics[0].id",
                                                is(dtoDetailedFactorEvaluation.getMetrics().get(0).getId())))
                                .andExpect(jsonPath("$[0].metrics[0].name",
                                                is(dtoDetailedFactorEvaluation.getMetrics().get(0).getName())))
                                .andExpect(jsonPath("$[0].metrics[0].description",
                                                is(dtoDetailedFactorEvaluation.getMetrics().get(0).getDescription())))
                                .andExpect(jsonPath("$[0].metrics[0].value",
                                                is(HelperFunctions.getFloatAsDouble(dtoDetailedFactorEvaluation
                                                                .getMetrics().get(0).getValue()))))
                                .andExpect(jsonPath("$[0].metrics[0].value_description",
                                                is(String.format("%.2f",
                                                                dtoDetailedFactorEvaluation.getMetrics().get(0)
                                                                                .getValue()))))
                                .andExpect(jsonPath("$[0].metrics[0].date[0]",
                                                is(dtoDetailedFactorEvaluation.getMetrics().get(0).getDate()
                                                                .getYear())))
                                .andExpect(jsonPath("$[0].metrics[0].date[1]",
                                                is(dtoDetailedFactorEvaluation.getMetrics().get(0).getDate()
                                                                .getMonthValue())))
                                .andExpect(jsonPath("$[0].metrics[0].date[2]",
                                                is(dtoDetailedFactorEvaluation.getMetrics().get(0).getDate()
                                                                .getDayOfMonth())))
                                .andExpect(jsonPath("$[0].metrics[0].datasource", is(nullValue())))
                                .andExpect(jsonPath("$[0].metrics[0].rationale",
                                                is(dtoDetailedFactorEvaluation.getMetrics().get(0).getRationale())))
                                ...
                                .andExpect(jsonPath("$[0].metrics[0].qualityFactors",
                                                is(dtoDetailedFactorEvaluation.getMetrics().get(0)
                                                                .getQualityFactors())))
                ...
                // Verify mock interactions
                verify(qualityFactorsDomainController, times(1))
        ...
        public void getQualityFactorsHistoricalDataForOneStrategicIndicator() throws Exception {
                ...
                when(qualityFactorsDomainController.getFactorsWithMetricsForOneStrategicIndicatorHistoricalEvaluation(
                                strategicIndicatorId, projectExternalId, from, to))
                                .thenReturn(dtoDetailedFactorEvaluationList);

                // Perform request
                RequestBuilder requestBuilder = RestDocumentationRequestBuilders
                                .get("/api/strategicIndicators/{id}/qualityFactors/metrics/historical",
                                                strategicIndicatorId)
                                .param("prj", projectExternalId)
        ...
        public void getQualityFactorsPredictionDataForOneStrategicIndicator() throws Exception {
                // Given
                DTODetailedFactorEvaluation dtoDetailedFactorEvaluation = domainObjectsBuilder
                ...
                when(qualityFactorsDomainController.getFactorsWithMetricsForOneStrategicIndicatorCurrentEvaluation(
                                strategicIndicatorId, projectExternalId)).thenReturn(dtoDetailedFactorEvaluationList);
                when(qualityFactorsDomainController.getFactorsWithMetricsPrediction(dtoDetailedFactorEvaluationList,
                                technique, freq, horizon, projectExternalId))
                                .thenReturn(dtoDetailedFactorEvaluationList);

                // Perform request
                RequestBuilder requestBuilder = RestDocumentationRequestBuilders
                                .get("/api/strategicIndicators/{id}/qualityFactors/metrics/prediction",
                                                strategicIndicatorId)
                                .param("prj", projectExternalId)
                                .param("technique", technique)
                                .param("horizon", horizon);
                ...
                this.mockMvc.perform(requestBuilder)
                                ...
                                .andExpect(jsonPath("$[0].metrics[0].date[2]",
                                                is(dtoDetailedFactorEvaluation.getMetrics().get(0).getDate()
                                                                .getDayOfMonth())))
                                .andExpect(jsonPath("$[0].metrics[0].datasource",
                                                is(dtoDetailedFactorEvaluation.getMetrics().get(0).getDatasource())))
                                .andExpect(jsonPath("$[0].metrics[0].rationale",
                                                is(dtoDetailedFactorEvaluation.getMetrics().get(0).getRationale())))
                                .andExpect(jsonPath("$[0].metrics[0].confidence80.first",
                                                is(HelperFunctions.getFloatAsDouble(dtoDetailedFactorEvaluation
                                                                .getMetrics().get(0).getConfidence80().getFirst()))))
                                .andExpect(jsonPath("$[0].metrics[0].confidence80.second",
                                                is(HelperFunctions.getFloatAsDouble(dtoDetailedFactorEvaluation
                                                                .getMetrics().get(0).getConfidence80().getSecond()))))
                                .andExpect(jsonPath("$[0].metrics[0].confidence95.first",
                                                is(HelperFunctions.getFloatAsDouble(dtoDetailedFactorEvaluation
                                                                .getMetrics().get(0).getConfidence95().getFirst()))))
                                .andExpect(jsonPath("$[0].metrics[0].confidence95.second",
                                                is(HelperFunctions.getFloatAsDouble(dtoDetailedFactorEvaluation
                                                                .getMetrics().get(0).getConfidence95().getSecond()))))
                                .andExpect(jsonPath("$[0].metrics[0].forecastingError", is(nullValue())))
                                .andExpect(jsonPath("$[0].metrics[0].qualityFactors",
                                                is(dtoDetailedFactorEvaluation.getMetrics().get(0)
                                                                .getQualityFactors())))
                ...
                verify(qualityFactorsDomainController, times(1))
                                .getFactorsWithMetricsForOneStrategicIndicatorCurrentEvaluation(strategicIndicatorId,
                                                projectExternalId);
                verify(qualityFactorsDomainController, times(1)).getFactorsWithMetricsPrediction(
                                dtoDetailedFactorEvaluationList, technique, freq, horizon, projectExternalId);
        }
        ...
        public void getAllStrategicIndicators() throws Exception {
                ...
                Long siqf1Id = 1L;
                StrategicIndicatorQualityFactors siqf1 = new StrategicIndicatorQualityFactors(factor1, -1,
                                strategicIndicator);
                siqf1.setId(siqf1Id);
                ...
                Long siqf2Id = 2L;
                StrategicIndicatorQualityFactors siqf2 = new StrategicIndicatorQualityFactors(factor2, -1,
                                strategicIndicator);
                siqf2.setId(siqf2Id);
                ...
                Metric metric3 = new Metric("fasttests", "Fast Tests",
                                "Percentage of tests under the testing duration threshold", project,
                ...
                Long siqf3Id = 3L;
                StrategicIndicatorQualityFactors siqf3 = new StrategicIndicatorQualityFactors(factor3, -1,
                                strategicIndicator);
                siqf3.setId(siqf3Id);
                ...
                when(strategicIndicatorsDomainController
                                .getStrategicIndicatorsByProjectAndProfile(project.getExternalId(), profileId))
                                .thenReturn(strategicIndicatorList);
        ...
        public void getStrategicIndicator() throws Exception {
                ...
                File networkFile = new File(
                                "src/test/java/com/upc/gessi/qrapids/app/testHelpers/WSA_ProductQuality.dne");
                strategicIndicator.setNetwork(IOUtils.toByteArray(networkFile.toURI()));
                when(strategicIndicatorsDomainController.getStrategicIndicatorById(strategicIndicator.getId()))
                                .thenReturn(strategicIndicator);
                ...
                this.mockMvc.perform(requestBuilder)
                                ...
                                .andExpect(jsonPath("$.threshold",
                                                is(Double.valueOf(strategicIndicator.getThreshold().toString()))))
                                .andExpect(jsonPath("$.network", is(notNullValue())))
                                .andExpect(jsonPath("$.qualityFactors", hasSize(3)))
                                .andExpect(jsonPath("$.qualityFactors[0]",
                                                is(strategicIndicator.getQuality_factorsIds().get(0))))
                                .andExpect(jsonPath("$.qualityFactors[1]",
                                                is(strategicIndicator.getQuality_factorsIds().get(1))))
                                .andExpect(jsonPath("$.qualityFactors[2]",
                                                is(strategicIndicator.getQuality_factorsIds().get(2))))
                ...
                // Verify mock interactions
                verify(strategicIndicatorsDomainController, times(1))
                                .getStrategicIndicatorById(strategicIndicator.getId());
                verifyNoMoreInteractions(strategicIndicatorsDomainController);
        }
        ...
        public void getMissingStrategicIndicator() throws Exception {
                ...
                when(strategicIndicatorsDomainController.getStrategicIndicatorById(strategicIndicatorId))
                                .thenThrow(new StrategicIndicatorNotFoundException(strategicIndicatorId.toString()));
        ...
        public void newStrategicIndicator() throws Exception {
                ...
                File networkFile = new File(
                                "src/test/java/com/upc/gessi/qrapids/app/testHelpers/WSA_ProductQuality.dne");
                MockMultipartFile network = new MockMultipartFile("network", "network.dne", "text/plain",
                                Files.readAllBytes(networkFile.toPath()));

                when(strategicIndicatorsDomainController.assessStrategicIndicator(strategicIndicator.getName(),
                                strategicIndicator.getProject().getExternalId())).thenReturn(true);
                ...
                verify(strategicIndicatorsDomainController, times(1)).saveStrategicIndicator(
                                eq(strategicIndicator.getName()), eq(strategicIndicator.getDescription()),
                                eq(strategicIndicator.getThreshold().toString()), any(),
                                eq(strategicIndicator.getQuality_factors()), eq(project));
                verify(strategicIndicatorsDomainController, times(1)).assessStrategicIndicator(
                                strategicIndicator.getName(), strategicIndicator.getProject().getExternalId());
                verifyNoMoreInteractions(strategicIndicatorsDomainController);
        }
        ...
        public void newStrategicIndicatorAssessmentError() throws Exception {
                ...
                when(strategicIndicatorsDomainController.assessStrategicIndicator(strategicIndicator.getName(),
                                strategicIndicator.getProject().getExternalId())).thenReturn(false);
        ...
        public void editStrategicIndicator() throws Exception {
                ...
                when(strategicIndicatorsDomainController.getStrategicIndicatorById(strategicIndicator.getId()))
                                .thenReturn(strategicIndicator);
                when(strategicIndicatorsDomainController.assessStrategicIndicator(strategicIndicator.getName(),
                                project.getExternalId())).thenReturn(true);
                ...
                verify(strategicIndicatorsDomainController, times(1))
                                .getStrategicIndicatorById(strategicIndicator.getId());
                verify(strategicIndicatorsDomainController, times(1)).editStrategicIndicator(
                                eq(strategicIndicator.getId()), eq(strategicIndicator.getName()),
                                eq(strategicIndicator.getDescription()),
                                eq(strategicIndicator.getThreshold().toString()), any(),
                                eq(strategicIndicator.getWeights()));
                verify(strategicIndicatorsDomainController, times(1)).assessStrategicIndicator(
                                strategicIndicator.getName(), strategicIndicator.getProject().getExternalId());
                verifyNoMoreInteractions(strategicIndicatorsDomainController);
        }
        ...
        @Test
        public void editStrategicIndicatorAssessment()
                        throws Exception, StrategicIndicatorQualityFactorNotFoundException {
                // Given
                Project project = domainObjectsBuilder.buildProject();
                Strategic_Indicator strategicIndicator = domainObjectsBuilder.buildStrategicIndicator(project);
                File networkFile = new File(
                ...
                verify(strategicIndicatorsDomainController, times(1)).editStrategicIndicator(
                                ...
                                eq(strategicIndicator.getWeights()));
                verify(strategicIndicatorsDomainController, times(1))
                                .assessStrategicIndicator(strategicIndicator.getName(), project.getExternalId());
                verifyNoMoreInteractions(strategicIndicatorsDomainController);
        }
        ...
        public void editStrategicIndicatorAssessmentError() throws Exception {
                ...
                when(strategicIndicatorsDomainController.getStrategicIndicatorById(strategicIndicator.getId()))
                                .thenReturn(strategicIndicator);
                when(strategicIndicatorsDomainController.assessStrategicIndicator(strategicIndicator.getName(),
                                project.getExternalId())).thenReturn(false);
                ...
                verify(strategicIndicatorsDomainController, times(1)).editStrategicIndicator(
                                eq(strategicIndicator.getId()), eq(strategicIndicator.getName()),
                                eq(strategicIndicator.getDescription()),
                                eq(strategicIndicator.getThreshold().toString()), any(), eq(qualityFactors));
                verify(strategicIndicatorsDomainController, times(1))
                                .assessStrategicIndicator(strategicIndicator.getName(), project.getExternalId());
                verifyNoMoreInteractions(strategicIndicatorsDomainController);
        }
        ...
        @Test
        public void editStrategicIndicatorIntegrityViolation()
                        throws Exception, StrategicIndicatorQualityFactorNotFoundException {
                // Given
                Project project = domainObjectsBuilder.buildProject();
                Strategic_Indicator strategicIndicator = domainObjectsBuilder.buildStrategicIndicator(project);
                ...
                when(strategicIndicatorsDomainController.getStrategicIndicatorById(strategicIndicator.getId()))
                                .thenReturn(strategicIndicator);
                when(strategicIndicatorsDomainController.editStrategicIndicator(eq(strategicIndicator.getId()),
                                eq(strategicIndicator.getName()), eq(strategicIndicator.getDescription()),
                                eq(strategicIndicator.getThreshold().toString()), any(),
                                eq(strategicIndicator.getQuality_factors())))
        ...
        public void deleteOneStrategicIndicatorNotFound() throws Exception {
                Long strategicIndicatorId = 1L;
                doThrow(new StrategicIndicatorNotFoundException(strategicIndicatorId.toString()))
                                .when(strategicIndicatorsDomainController)
                                .deleteStrategicIndicator(strategicIndicatorId);
        ...
        public void newStrategicIndicatorsCategories() throws Exception {
                // Given
                List<Map<String, String>> strategicIndicatorCategoriesList = domainObjectsBuilder
                                .buildRawSICategoryList();
                ...
                // Verify mock interactions
                verify(strategicIndicatorsDomainController, times(1))
                                .newStrategicIndicatorCategories(strategicIndicatorCategoriesList);
                verifyNoMoreInteractions(strategicIndicatorsDomainController);
        }
        ...
        public void newStrategicIndicatorsCategoriesNotEnough() throws Exception {
                ...
                // Note: validation is commented out in controller, so this will succeed
        ...
        public void assesStrategicIndicatorsLegacy() throws Exception {
                ...
                when(strategicIndicatorsDomainController.assessStrategicIndicators(projectExternalId, null))
                                .thenReturn(true);
                when(projectsController.getAllProjectsExternalID())
                                .thenReturn(Collections.singletonList(projectExternalId));
                ...
                verifyNoMoreInteractions(qualityFactorsDomainController);
                verify(strategicIndicatorsDomainController, times(1)).assessStrategicIndicators(projectExternalId,
                                null);
                verifyNoMoreInteractions(strategicIndicatorsDomainController);
        }
        ...
        public void simulate() throws Exception {
                ...
                DTOStrategicIndicatorEvaluation dtoStrategicIndicatorEvaluation = domainObjectsBuilder
                                .buildDTOStrategicIndicatorEvaluation();
                ...
                when(strategicIndicatorsDomainController.simulateStrategicIndicatorsAssessment(eq(factorSimulatedMap),
                                eq(projectExternalId), eq(profileId))).thenReturn(dtoStrategicIndicatorEvaluationList);
                ...
                this.mockMvc.perform(requestBuilder)
                                ...
                                .andExpect(jsonPath("$[0].description",
                                                is(dtoStrategicIndicatorEvaluation.getDescription())))
                                .andExpect(jsonPath("$[0].value.first",
                                                is(HelperFunctions.getFloatAsDouble(dtoStrategicIndicatorEvaluation
                                                                .getValue().getFirst()))))
                                .andExpect(jsonPath("$[0].value.second",
                                                is(dtoStrategicIndicatorEvaluation.getValue().getSecond())))
                                .andExpect(jsonPath("$[0].confidence80", is(nullValue())))
                                ...
                                .andExpect(jsonPath("$[0].probabilities[0].upperThreshold",
                                                is(HelperFunctions.getFloatAsDouble(dtoStrategicIndicatorEvaluation
                                                                .getProbabilities().get(0).getUpperThreshold()))))
                                .andExpect(jsonPath("$[0].probabilities[1].id",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(1).getId()
                                                                .intValue())))
                                .andExpect(jsonPath("$[0].probabilities[1].label",
                                ...
                                .andExpect(jsonPath("$[0].probabilities[1].upperThreshold",
                                                is(HelperFunctions.getFloatAsDouble(dtoStrategicIndicatorEvaluation
                                                                .getProbabilities().get(1).getUpperThreshold()))))
                                .andExpect(jsonPath("$[0].probabilities[2].id",
                                                is(dtoStrategicIndicatorEvaluation.getProbabilities().get(2).getId()
                                                                .intValue())))
                                .andExpect(jsonPath("$[0].probabilities[2].label",
                                ...
                                .andExpect(jsonPath("$[0].probabilities[2].upperThreshold",
                                                is(HelperFunctions.getFloatAsDouble(dtoStrategicIndicatorEvaluation
                                                                .getProbabilities().get(2).getUpperThreshold()))))
                ...
                // Verify mock interactions
                verify(strategicIndicatorsDomainController, times(1)).simulateStrategicIndicatorsAssessment(
                                eq(factorSimulatedMap), eq(projectExternalId), eq(profileId));
                verifyNoMoreInteractions(strategicIndicatorsDomainController);
        }
        ...
        public void simulateError() throws Exception {
                ...
                when(strategicIndicatorsDomainController.simulateStrategicIndicatorsAssessment(eq(factorSimulatedMap),
                                eq(projectExternalId), eq(profileId))).thenThrow(new IOException());
        ...
        public void getQualityModel() throws Exception {
                ...
                String projectExternalId = "test";
                String profileId = "null"; // without profile
                when(strategicIndicatorsDomainController.getQualityModel(projectExternalId, profileId, null))
                                .thenReturn(dtoRelationsSIList);
                ...
                this.mockMvc.perform(requestBuilder)
                                ...
                                .andExpect(jsonPath("$[0].factors[0].weightedValue",
                                                is(dtoRelationsFactor.getWeightedValue())))
                                .andExpect(jsonPath("$[0].factors[0].weight", is(dtoRelationsFactor.getWeight())))
                                .andExpect(jsonPath("$[0].factors[0].assessmentValue",
                                                is(dtoRelationsFactor.getAssessmentValue())))
                                .andExpect(jsonPath("$[0].factors[0].metrics", hasSize(1)))
                                .andExpect(jsonPath("$[0].factors[0].metrics[0].id", is(dtoRelationsMetric.getId())))
                                .andExpect(jsonPath("$[0].factors[0].metrics[0].weightedValue",
                                                is(dtoRelationsMetric.getWeightedValue())))
                                .andExpect(jsonPath("$[0].factors[0].metrics[0].weight",
                                                is(dtoRelationsMetric.getWeight())))
                                .andExpect(jsonPath("$[0].factors[0].metrics[0].assessmentValue",
                                                is(dtoRelationsMetric.getAssessmentValue())));

                // Verify mock interactions
                verify(strategicIndicatorsDomainController, times(1)).getQualityModel(projectExternalId, profileId,
                                null);
                verifyNoMoreInteractions(strategicIndicatorsDomainController);
        }
        ...
        public void getQualityModelForDate() throws Exception {
                ...
                when(strategicIndicatorsDomainController.getQualityModel(projectExternalId, profileId,
                                LocalDate.parse(date))).thenReturn(dtoRelationsSIList);
                ...
                this.mockMvc.perform(requestBuilder)
                                ...
                                .andExpect(jsonPath("$[0].factors[0].metrics", hasSize(1)))
                                .andExpect(jsonPath("$[0].factors[0].metrics[0].id", is(dtoRelationsMetric.getId())))
                                .andExpect(jsonPath("$[0].factors[0].metrics[0].name",
                                                is(dtoRelationsMetric.getName())))
                                .andExpect(jsonPath("$[0].factors[0].metrics[0].weightedValue",
                                                is(dtoRelationsMetric.getWeightedValue())))
                                .andExpect(jsonPath("$[0].factors[0].metrics[0].weight",
                                                is(dtoRelationsMetric.getWeight())))
        ...
        public void getStrategicIndicatorsCurrentHistoricEvaluation() throws Exception {
                ...
                this.mockMvc.perform(requestBuilder)
                                ...
                                .andExpect(jsonPath("$[0].dbId",
                                                is(dtoSICurrentHistoricEvaluation.getDbId().intValue())))
                                ...
                                .andExpect(jsonPath("$[0].description",
                                                is(dtoSICurrentHistoricEvaluation.getDescription())))
                                .andExpect(jsonPath("$[0].currentValue.first",
                                                is(getFloatAsDouble(dtoSICurrentHistoricEvaluation.getCurrentValue()
                                                                .getFirst()))))
                                .andExpect(jsonPath("$[0].currentValue.second",
                                                is(dtoSICurrentHistoricEvaluation.getCurrentValue().getSecond())))
                                .andExpect(jsonPath("$[0].currentValueDescription",
                                                is(dtoSICurrentHistoricEvaluation.getCurrentValueDescription())))
                                .andExpect(jsonPath("$[0].currentRationale",
                                                is(dtoSICurrentHistoricEvaluation.getCurrentRationale())))
                                .andExpect(jsonPath("$[0].probabilities", hasSize(3)))
                                .andExpect(jsonPath("$[0].probabilities[0].id",
                                                is(dtoSICurrentHistoricEvaluation.getProbabilities().get(0).getId()
                                                                .intValue())))
                                .andExpect(jsonPath("$[0].probabilities[0].label",
                                                is(dtoSICurrentHistoricEvaluation.getProbabilities().get(0)
                                                                .getLabel())))
                                .andExpect(jsonPath("$[0].probabilities[0].value",
                                                is(dtoSICurrentHistoricEvaluation.getProbabilities().get(0)
                                                                .getValue())))
                                .andExpect(jsonPath("$[0].probabilities[0].color",
                                                is(dtoSICurrentHistoricEvaluation.getProbabilities().get(0)
                                                                .getColor())))
                                .andExpect(jsonPath("$[0].probabilities[0].upperThreshold",
                                                is(getFloatAsDouble(dtoSICurrentHistoricEvaluation.getProbabilities()
                                                                .get(0).getUpperThreshold()))))
                                .andExpect(jsonPath("$[0].probabilities[1].id",
                                                is(dtoSICurrentHistoricEvaluation.getProbabilities().get(1).getId()
                                                                .intValue())))
                                .andExpect(jsonPath("$[0].probabilities[1].label",
                                                is(dtoSICurrentHistoricEvaluation.getProbabilities().get(1)
                                                                .getLabel())))
                                .andExpect(jsonPath("$[0].probabilities[1].value",
                                                is(dtoSICurrentHistoricEvaluation.getProbabilities().get(1)
                                                                .getValue())))
                                ...
                                .andExpect(jsonPath("$[0].probabilities[1].upperThreshold",
                                                is(getFloatAsDouble(dtoSICurrentHistoricEvaluation.getProbabilities()
                                                                .get(1).getUpperThreshold()))))
                                .andExpect(jsonPath("$[0].probabilities[2].id",
                                                is(dtoSICurrentHistoricEvaluation.getProbabilities().get(2).getId()
                                                                .intValue())))
                                .andExpect(jsonPath("$[0].probabilities[2].label",
                                                is(dtoSICurrentHistoricEvaluation.getProbabilities().get(2)
                                                                .getLabel())))
                                .andExpect(jsonPath("$[0].probabilities[2].value",
                                                is(dtoSICurrentHistoricEvaluation.getProbabilities().get(2)
                                                                .getValue())))
                                ...
                                .andExpect(jsonPath("$[0].probabilities[2].upperThreshold",
                                                is(getFloatAsDouble(dtoSICurrentHistoricEvaluation.getProbabilities()
                                                                .get(2).getUpperThreshold()))))
                                .andExpect(jsonPath("$[0].currentDate[0]",
                                                is(dtoSICurrentHistoricEvaluation.getCurrentDate().getYear())))
                                .andExpect(jsonPath("$[0].currentDate[1]",
                                                is(dtoSICurrentHistoricEvaluation.getCurrentDate().getMonthValue())))
                                .andExpect(jsonPath("$[0].currentDate[2]",
                                                is(dtoSICurrentHistoricEvaluation.getCurrentDate().getDayOfMonth())))
                                .andExpect(jsonPath("$[0].historicalDataList", hasSize(1)))
                                .andExpect(jsonPath("$[0].historicalDataList[0].value.first",
                                                is(getFloatAsDouble(dtoHistoricalData.getValue().getFirst()))))
                                .andExpect(jsonPath("$[0].historicalDataList[0].value.second",
                                                is(dtoHistoricalData.getValue().getSecond())))
                                .andExpect(jsonPath("$[0].historicalDataList[0].valueDescription",
                                                is(dtoHistoricalData.getValueDescription())))
                                .andExpect(jsonPath("$[0].historicalDataList[0].rationale",
                                                is(dtoHistoricalData.getRationale())))
                                .andExpect(jsonPath("$[0].historicalDataList[0].date[0]",
                                                is(dtoHistoricalData.getDate().getYear())))
                                .andExpect(jsonPath("$[0].historicalDataList[0].date[1]",
                                                is(dtoHistoricalData.getDate().getMonthValue())))
                                .andExpect(jsonPath("$[0].historicalDataList[0].date[2]",
                                                is(dtoHistoricalData.getDate().getDayOfMonth())))
